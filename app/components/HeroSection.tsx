				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						<h1 className="text-4xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-teal-500">
							Tharun Reddy Kathulla
						</h1>
						<h2 className="text-2xl md:text-4xl font-bold text-white">Software Engineer</h2>
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							I’m a passionate full-stack developer who crafts scalable, high-performance web applications with clean architecture and intuitive design.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							Experienced in building real-time platforms, integrating ML/AI APIs, and developing robust backend systems using Spring Boot, Node.js, and Python.
						</p>
					</div>
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 md:mb-8">
						...
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">Spring Boot</span>
